#A better algorithm with O(nlogn) time complexity
...
# Driver Code 
# Given array is 
readfile = open(r"C:\Users\DIVYALOK\Downloads\Algo_Assign_Material\Assignment2.txt", "r+")
readlines = readfile.readlines()
lines = [line.replace("\n", "") for line in readlines]
n = len(lines) 
result = mergeSort(lines, n) 
